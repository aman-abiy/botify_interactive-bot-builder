                            ...
                            <form v-on:submit.prevent="handleSubmit(signup)">
                                ...
                                <div class="form-group">
                                    <ValidationProvider rules="required|password:@password" v-slot="{ errors }">
                                        ...
                                        <div class="input-group">
                                            <input ref="passwordInputConfirmation" v-model="confirmation" type="password" name="password-Confirmation" id="password-Confirmation" class="form-control" data-toggle="password">
